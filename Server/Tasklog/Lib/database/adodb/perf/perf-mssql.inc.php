...
class perf_mssql extends adodb_perf{
	...
	'Ratios',
		'data cache hit ratio' => array('RATIO',
			"select round((a.cntr_value*100.0)/b.cntr_value,2) from master.sysperfinfo a, master.sysperfinfo b where a.counter_name = 'Buffer cache hit ratio' and b.counter_name='Buffer cache hit ratio base'",
			'=WarnCacheRatio'),
	...
	'IO',
		'data reads' => array('IO',
		"select cntr_value from master.sysperfinfo where counter_name = 'Page reads/sec'"),
		'data writes' => array('IO',
		"select cntr_value from master.sysperfinfo where counter_name = 'Page writes/sec'"),
			
	'Data Cache',
		'data cache size' => array('DATAC',
		"select cntr_value*8192 from master.sysperfinfo where counter_name = 'Total Pages' and object_name='SQLServer:Buffer Manager'",
			'' ),
