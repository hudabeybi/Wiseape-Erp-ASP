...
namespace Com.Wiseape.Framework
{
    ...
    public class Temp
    {
        public static void SaveSampleAssemblies()
        {
            ...
            configs.FactoryConfigurations.Add(new FactoryConfiguration( new AssemblyInfo("Com.Wiseape.Gateway.UserManagement.Data.dll", "Com.Wiseape.Gateway.UserManagement.Repository.RecipeRepository"),
                new AssemblyType("Recipe", ClassType.clsTypeRepository), "Recipe Repository"));
            configs.FactoryConfigurations.Add(new FactoryConfiguration(new AssemblyInfo("Com.Wiseape.Gateway.UserManagement.Data.dll", "Com.Wiseape.Gateway.UserManagement.Repository.FoodRepository"),
               new AssemblyType("Food", ClassType.clsTypeRepository), "Food Repository"));

            string xml = Serializer.XML.Serialize(configs);
            System.IO.File.WriteAllText(System.IO.Directory.GetCurrentDirectory() + "/Com.Wiseape.Gateway.UserManagement.Webservice.Config", xml);
        }
    }
