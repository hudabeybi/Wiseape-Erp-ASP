...
namespace Com.Wiseape.Utility.Database
{
    public class QueryConditionAndConverter : Com.Wiseape.Utility.ListUtility.IListProcessor
    {
    ...
    public class QueryConditionOrConverter : Com.Wiseape.Utility.ListUtility.IListProcessor
    {
        public string Process(IDictionary<string, object> list)
        {
            string where = "";
