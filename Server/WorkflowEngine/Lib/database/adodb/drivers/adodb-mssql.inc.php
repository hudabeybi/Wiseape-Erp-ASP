...
"select c.name,t.name,c.length,
	...
	{
		//ini dirubah sama huda ganteng, soalnya hasilnya ngaco data tidak dimulai dari row 0
		// ini aslinya if ($nrows > 0 && $offset <= 0) {
...
order by constraint_name, referenced_table_name, keyno";
	...
	function _connect($argHostname, $argUsername, $argPassword, $argDatabasename)
	{
		...
		$this->__ConnectionId = $this->_connectionID;
	...
	*/
	...
	function _query($sql,$inputarr)
	{
		...
		if (is_array($inputarr)) {
			...
			//echo $sql;
			//echo $this->_connectionID."<br>";
			if($this->_connectionID == "")
				$this->_connectionID = $this->__ConnectionId;
