...
/***********************************************************************
* 
* 	File Name: com_ApplicationModule.php
* 	Created Date: 6/5/2017 3:21:02 PM
*   Description:
*	This component class serves as controller object for Application Module.
*   This class handles all the view, detail, edit, add, delete, and other request from Application Module module.
*   This class inherits com_ListCtrl component
* **********************************************************************/


class com_ApplicationModule extends com_ListCtrl
{

	function com_ApplicationModule()
	{
		$this->componentName = "com_ApplicationModule";
	...
	*/
	function getSearchColumns()
	{
		...
		$cols [] = "application.ApplicationName";

		$cols [] = "application.ApplicationTitle";

		$cols [] = "application.ApplicationInfo";

		$cols [] = "application.ApplicationIconSmall";

		$cols [] = "application.ApplicationIconMiddle";

		$cols [] = "application.ApplicationIconLarge";

		$cols [] = "application.ApplicationPath";

		$cols [] = "application.ApplicationFile";

		$cols [] = "application.ApplicationClass";

		$cols [] = "application.ApplicationMainFunction";
