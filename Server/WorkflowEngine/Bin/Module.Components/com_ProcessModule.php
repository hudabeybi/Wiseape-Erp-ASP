...
*   Description:
*	This component class serves as controller object for ProcessModule.
*   This class handles all the view, detail, edit, add, delete, and other request from ProcessModule module.
