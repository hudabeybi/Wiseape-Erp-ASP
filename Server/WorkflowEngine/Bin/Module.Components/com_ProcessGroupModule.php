...
/***********************************************************************
* 
* 	File Name: com_ProcessGroupModule.php
* 	Created Date: 6/5/2017 3:40:30 PM
*   Description:
*	This component class serves as controller object for ProcessGroupModule.
*   This class handles all the view, detail, edit, add, delete, and other request from ProcessGroupModule module.
*   This class inherits com_ListCtrl component
* **********************************************************************/


class com_ProcessGroupModule extends com_ListCtrl
{

	function com_ProcessGroupModule()
	{
		$this->componentName = "com_ProcessGroupModule";
	
		$this->children [] = "com_ProcessModule";
	...
	*/
	function getSearchColumns()
	{
		...
		$cols [] = "processgroup.ProcessGroupName";

		$cols [] = "processgroup.ProcessGroupTitle";

		$cols [] = "processgroup.ProcessGroupInfo";
