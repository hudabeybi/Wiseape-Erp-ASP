...
//**********************************************************************
//
//	Class Name: GalleryModuleAdapter
...
class GalleryModuleAdapter extends galleryAdapter
{
	...
	//Select Query for ViewGalleryModuleData override parent's getSelectQuery()
	...
	//Select Query Count for ViewGalleryModuleData override parent's getSelectQueryCount()
	...
	//Get query for detail GalleryModule data
	public function getSelectDetailQuery( $id)
	{
		$condition = "";
	
		$condition .= "gallery.IdGallery = ".$id;
	...
	//Initialize View GalleryModule, it initializes from record set the View object for this module
	...
	//Insert GalleryModule object to database, inherit from galleryAdapter
	...
	//Update GalleryModule object to database, inherit from galleryAdapter
	...
	//Delete GalleryModule object to database, inherit from galleryAdapter
	public function delete( $o)
	{
		//Delete the data by primary key
		parent::delete( $o->IdGallery);
	...
	//Get list of  GalleryModule objects, override the parent's function
	public function getAll( $condition="", $order="", $offset="", $limit="", $returnRecordSet = false)
	{
		$list = array();
		$order = ( $order == "" ) ? $this->sortBy() : $order ;
		//Get data query for the GalleryModule data
		$query = $this->getSelectQuery();
		if( str_replace(" ", "", $condition) != "")
		...
		//Retrieve the GalleryModule data
		...
		else
		{
			...
			while(!$rs->EOF)
			{
				//Instansiate the GalleryModule object
				$o = $this->createNew();

				//Init the GalleryModule object
				$o = $this->init($rs, $o);

				//Assembel the GalleryModule object list
				array_push( $list, $o);
			...
			//Return the GalleryModule object list
			return $list;
		}
	}

	//Get total data of GalleryModule, override the parent's function
	public function getCount( $condition="")
	{
		//Get data query count for the GalleryModule data
	...
	//Get Detail of GalleryModule Object
	...
	//Create new object of ViewGalleryModuleData
	function createNew()
	{
		include_once( "Bin/Module.DataModel/GalleryModuleData.php");
		$o = new ViewGalleryModuleData();
		return $o;
	}
