...
/***********************************************************************
* 
* 	File Name: com_UserModule.php
* 	Created Date: 6/5/2017 5:31:38 PM
*   Description:
*	This component class serves as controller object for User.
*   This class handles all the view, detail, edit, add, delete, and other request from User module.
*   This class inherits com_ListCtrl component
* **********************************************************************/


class com_UserModule extends com_ListCtrl
{

	function com_UserModule()
	{
		$this->componentName = "com_UserModule";
