...
/***********************************************************************
* 
* 	File Name: com_PostModule.php
* 	Created Date: 6/5/2017 5:31:41 PM
*   Description:
*	This component class serves as controller object for Post.
*   This class handles all the view, detail, edit, add, delete, and other request from Post module.
*   This class inherits com_ListCtrl component
* **********************************************************************/


class com_PostModule extends com_ListCtrl
{

	function com_PostModule()
	{
		$this->componentName = "com_PostModule";
	...
	*/
	function getSearchColumns()
	{
		...
		$cols [] = "post.PostSubTitle";

		$cols [] = "post.PostDate";

		$cols [] = "post.PostShortText";
