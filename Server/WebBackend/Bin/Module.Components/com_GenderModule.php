...
/***********************************************************************
* 
* 	File Name: com_GenderModule.php
* 	Created Date: 6/5/2017 5:31:48 PM
*   Description:
*	This component class serves as controller object for Gender.
*   This class handles all the view, detail, edit, add, delete, and other request from Gender module.
*   This class inherits com_ListCtrl component
* **********************************************************************/


class com_GenderModule extends com_ListCtrl
{

	function com_GenderModule()
	{
		$this->componentName = "com_GenderModule";
	...
	*/
	function getSearchColumns()
	{
		...
		$cols [] = "gender.GenderName";

		$cols [] = "gender.GenderInfo";
