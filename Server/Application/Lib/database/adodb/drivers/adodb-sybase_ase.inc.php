...
class ADODB_sybase_ase extends ADODB_sybase {
	 ...
	 var $metaDatabasesSQL ="SELECT a.name FROM master.sysdatabases a, master.syslogins b WHERE a.suid = b.suid and a.name like '%' and a.name != 'tempdb' and a.status3 != 256  order by 1";
