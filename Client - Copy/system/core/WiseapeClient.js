var WiseapeClient = Class({
	...
	run: function()
	{
		...
		this.getAllApplicationGroups(me, function(result)
		{
			console.log("application groups");
			console.log(result);
			//Run and initialize desktop
	...
	{
		var me = this;
		WebClient.get(me.serverConfig.webService + "/ApplicationItemService.svc/applicationitem/get-by-name/" + appName, function(result)
		{
	...
	,
	loadApplication: function(me, appInfo)
	{
