var AppListProcess = Class(WiseapeApplication,
{
	...
	{
		var url = Config.ws + "/process/find/all/1/100";
		console.log("AppListProcess.getDataList()");
		console.log(url);
	...
	createWindowAndShow: function( me, result )
	{
		if(me.winList == null)
		{
			me.openForm(me, "Forms/FormListProcess.js", function(me, win)
			{
				win.show(result);
				me.winList = win;
			});
	...
	{
		param.command = "add";
		me.client.runApp("AppAddProcess", param, function(app)
		{
	...
	editItem: function(me, param, callback)
	{
		...
		console.log(param);
		me.client.runApp("AppEditProcess", param, function(app)
		{
			app.onExitApplication = function()
			{
				me.getAndDisplayData(me);
	...
	{	
		...
		console.log("Parameter");
		console.log(param);
		me.client.runApp("AppDeleteProcess", param, function(app)
		{
			app.onExitApplication = function()
			{
				me.getAndDisplayData(me);
