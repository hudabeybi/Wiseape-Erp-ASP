var AppListUser = Class(WiseapeApplication,
{
	...
	getDataList: function( me, callback)
	{
		...
		console.log("AppListUser.getDataList()");
		console.log(url);
	...
	createWindowAndShow: function( me, result )
	{
		if(me.winList == null)
		{
			me.openForm(me, "Forms/UserListForm.js", function(me, win)
			{
				win.show(result);
				me.winList = win;
			});
	...
	{
		param.command = "add";
		me.client.runApp("AppAddUser", param, function(app)
		{
	...
	editItem: function(me, param, callback)
	{
		...
		console.log(param);
		me.client.runApp("AppEditUser", param, function(app)
		{
			app.onExitApplication = function()
			{
				me.getAndDisplayData(me);
	...
	{	
		...
		console.log("Parameter");
		console.log(param);
		me.client.runApp("AppDeleteUser", param, function(app)
		{
			app.onExitApplication = function()
			{
				me.getAndDisplayData(me);
