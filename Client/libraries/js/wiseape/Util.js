...
var Util =
{
	...
	runLoader: function()
	{
		...
		$(div).css("left", "50%");
		$(div).css("top", "50%");
		$(div).css("background", "url(system/applications/Desktop/" + UserDisplaySetting.theme.loadingAnimation + ") no-repeat");
		...
		$(divbg).css("-moz-opacity", "0.8");
		$(divbg).css("-webkit-opacity", "0.8");
		$(divbg).css("width", "100%");
		$(divbg).css("height", "100%");
		$(divbg).css("z-index", "120000");
		$(divbg).append("<audio id=\"pop\"><source src=\"system/applications/Desktop/" + UserDisplaySetting.theme.loadingAnimationAudio + "\" type=\"audio/mpeg\"></audio>");
		$(divbg).append(div);
		$(document.body).append(divbg);
		try
		{
			Util.playPromise = $('audio#pop')[0].play();
		}
		catch (e)
		{
		}
	...
	stopLoader: function ()
	{
		try
		{
			if(Util.playPromise != null)
				$('audio#pop')[0].pause();
			Util.playPromise = null;
		}
		catch (e)
		{
		}
